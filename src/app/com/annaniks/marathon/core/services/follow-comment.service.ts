...
export class FollowCommentService {
    ...
    private _likeSubject = new Subject<{ isSend: boolean, isAuthorizated: boolean }>();
    ...
    public onLike(isAuthorizated: boolean) {
        this._likeSubject.next({ isSend: true, isAuthorizated: isAuthorizated })
    }
    public getLikeState() {
